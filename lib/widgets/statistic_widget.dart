      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  color: orange.withOpacity(0.1), shape: BoxShape.circle),
              child: Image.asset(
            ...
            Text(
              '279',
              style: regular.copyWith(color: orange, fontSize: 48),
            ),
            Text(
              'Kasus Positif',
              style: regular.copyWith(color: body, fontSize: 12),
            )
          ],
        ),
        Column(
          ...
          children: [
            ...
            Text(
              '122',
              style: regular.copyWith(color: green, fontSize: 48),
            ),
            Text(
              'Sembuh',
              style: regular.copyWith(color: body, fontSize: 12),
        ...
        Column(
          ...
          children: [
            ...
            Text(
              '279',
              style: regular.copyWith(color: red, fontSize: 48),
            ),
            Text(
              'Meninggal',
              style: regular.copyWith(color: body, fontSize: 12),
